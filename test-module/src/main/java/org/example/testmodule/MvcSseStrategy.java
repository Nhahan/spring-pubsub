...
@Slf4j
public class MvcSseStrategy implements SseStrategy {

    private final String sourceName = "MVC";
    ...
    public MvcSseStrategy(String url, int messageCount, CountDownLatch connectedLatch) {
        this.url = url;
    ...
    public void handleMessage(String sourceName) {
        // sourceName는 이 클래스 내에서 "MVC"로 고정되므로 인자를 사용할 필요가 없습니다.
